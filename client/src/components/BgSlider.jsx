...
const bgSlider = () => {
    ...
    return (
        <div className='pb-10 mb-py-20 mx-2'>
            {/* Title */}
            <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-4 mb-1 sm:mb-20 font-semibold bg-gradient-to-r from-gray-900 bg-clip-text text-transparent'>Remove Background With High <br /> Quality and Accuracy</h1>
